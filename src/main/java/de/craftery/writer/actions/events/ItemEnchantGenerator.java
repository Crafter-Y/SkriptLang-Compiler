...
public class ItemEnchantGenerator extends ActionGenerator {
    private final RawMethodSection bodyPart;
    public ItemEnchantGenerator() {
        this.setPackage("listener");
        this.setNeeded(true);

        int moduleInt = Main.nextModuleInt();
        String moduleName = "OnEnchant" + moduleInt;
        ...
        constructor.setRawMethodSignature("public OnEnchant"+ moduleInt +"()");
        ...
        methodSection.setRawMethodSignature("public void onEnchant(EnchantItemEvent event)");
        ...
        this.requireImport("org.bukkit.event.enchantment.EnchantItemEvent");
