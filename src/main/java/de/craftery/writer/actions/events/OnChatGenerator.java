...
public class OnChatGenerator extends ActionGenerator {
    private final RawMethodSection bodyPart;
    public OnChatGenerator() {
        this.setPackage("listener");
        this.setNeeded(true);

        int moduleInt = Main.nextModuleInt();
        String moduleName = "OnChat" + moduleInt;
        ...
        constructor.setRawMethodSignature("public OnChat"+ moduleInt +"()");
        ...
        methodSection.setRawMethodSignature("public void onChat(AsyncChatEvent event)");
        ...
        this.requireImport("io.papermc.paper.event.player.AsyncChatEvent");
